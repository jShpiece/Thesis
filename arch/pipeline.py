...
def filter_lens_positions(sources, lenses, xmax,
                          ...
                          slope_lo=0.4, slope_hi=1.7,
                          kappa_star_lo=1.0e-6, kappa_star_hi=10.0,
    ...
    if lens_type == 'SIS':
        ...
        slope_pinned = (
            (lenses.slope < slope_lo + slope_boundary_tol)
        ...
        kappa_pinned = (
            (lenses.kappa_star < kappa_star_lo * (1.0 + kappa_boundary_tol))
        ...
        valid_indices = ~(too_close | too_far | slope_pinned
                          | kappa_pinned | kappa_below_floor)
        lenses.x = lenses.x[valid_indices]
        lenses.y = lenses.y[valid_indices]
